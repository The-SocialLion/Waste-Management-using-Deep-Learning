...
training_set=train_datagen.flow_from_directory('DATASET/TRAIN',target_size=(64,64),batch_size=50,class_mode='binary')
val_set=val_datagen.flow_from_directory('DATASET/VAL',target_size=(64,64),batch_size=50,class_mode='binary')

model.fit_generator(training_set,steps_per_epoch=100,epochs=25,validation_data=val_set,validation_steps=2)
# saving the model
